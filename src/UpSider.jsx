...
export default function UpSider() {
  return (
    <div>
            <div className="home" >
        <div className="logo">
          ...
          <li>
          <Button style={{backgroundColor:'#121212' , border:'none'}}>
            <li>
          ...
          <li>
           ...
           <li>
            <Button style={{backgroundColor:'#121212' , border:'none'}}>
            <li className={style.li}>
            <svg width="24" height="24" className={style.icon} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path 
